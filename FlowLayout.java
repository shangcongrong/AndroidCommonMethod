...
import com.kaola.R;
import com.kaola.common.utils.DebugLog;
import com.kaola.common.utils.ScreenUtils;

import java.util.ArrayList;
import java.util.List;

/**
 * 可以自适应宽度，根据内部控件大小和内容换行的viewgroup
 * <p/>
 * Created by xinyang on 2014/11/19.
 */
public class FlowLayout extends ViewGroup {
    ...
    public List<String> tableStrs = new ArrayList<String>();
    ...
    private List<Integer> startX = new ArrayList<Integer>();
    ...
    public List<String> getTableStrs() {
        return tableStrs;
    }
